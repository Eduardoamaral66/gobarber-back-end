...
describe('SendForgotPasswordEmail', function () {
    it('should be able to recover the password using the email', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUsersRepository, fakeMailProvider, sendMailFunction, forgotEmailService, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeUsersRepository = new FakeUsersRepository_1.default();
                    fakeMailProvider = new FakeMailProvider_1.default();
                    sendMailFunction = jest.spyOn(fakeMailProvider, 'sendMail');
                    forgotEmailService = new SendForgotPasswordEmailService_1.default(fakeUsersRepository, fakeMailProvider);
                ...
                case 1:
                    user = _a.sent();
                    return [4 /*yield*/, forgotEmailService.execute({
                            email: 'johndoe@example.com',
                        })];
                case 2:
                    _a.sent();
                    expect(sendMailFunction).toHaveBeenCalledWith('johndoe@example.com', 'Senha');
                    return [2 /*return*/];
            }
        });
    }); });
    it('should not be able to recover a non-existing user password', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUsersRepository, fakeMailProvider, forgotEmailService;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeUsersRepository = new FakeUsersRepository_1.default();
                    fakeMailProvider = new FakeMailProvider_1.default();
                    forgotEmailService = new SendForgotPasswordEmailService_1.default(fakeUsersRepository, fakeMailProvider);
                    return [4 /*yield*/, expect(forgotEmailService.execute({
                            email: 'johndoe@example.com',
    ...
    it('should generate a forgot password token', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUsersRepository, fakeMailProvider, fakeUserTokensRepository, generateTokenFunction, forgotEmailService, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeUsersRepository = new FakeUsersRepository_1.default();
                    ...
                    generateTokenFunction = jest.spyOn(fakeUserTokensRepository, 'generate');
                    forgotEmailService = new SendForgotPasswordEmailService_1.default(fakeUsersRepository, fakeMailProvider);
                    return [4 /*yield*/, fakeUsersRepository.create({
                            name: 'John Doe',
                            email: 'johndoe@example.com',
