...
describe('AuthenticateUser', function () {
    it('should be able to authenticate', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUsersRepository, fakeHashProvider, authService, createUser, email, password, user, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeUsersRepository = new FakeUsersRepository_1.default();
                    fakeHashProvider = new FakeHashProvider_1.default();
                    authService = new AuthenticateUserService_1.default(fakeUsersRepository, fakeHashProvider);
    ...
    it('should not be able to authenticate with non existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUsersRepository, fakeHashProvider, authService, email, password;
        return __generator(this, function (_a) {
            fakeUsersRepository = new FakeUsersRepository_1.default();
            fakeHashProvider = new FakeHashProvider_1.default();
            authService = new AuthenticateUserService_1.default(fakeUsersRepository, fakeHashProvider);
            email = 'johndoe@example.com';
            password = '123456';
            expect(authService.execute({ email: email, password: password })).rejects.toBeInstanceOf(AppError_1.default);
            return [2 /*return*/];
        });
    }); });
    it('should not be able to authenticate with wrong password', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUsersRepository, fakeHashProvider, authService, createUser, email;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeUsersRepository = new FakeUsersRepository_1.default();
                ...
                case 1:
                    _a.sent();
                    expect(authService.execute({ email: email, password: 'wrong-pass' })).rejects.toBeInstanceOf(AppError_1.default);
                    return [2 /*return*/];
            }
        });
    }); });
